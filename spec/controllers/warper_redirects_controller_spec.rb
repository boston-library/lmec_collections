...
RSpec.describe WarperRedirectsController do
  describe 'GET #show' do
    describe 'with a valid warper id' do
      let(:redirect) { WarperRedirect.create!(warper_id: '12736', repository_id: 'bpl-test:zs25x875t') }

      it 'redirects to the repository item show view' do
